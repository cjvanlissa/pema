...
knitr::opts_chunk$set(
  collapse = TRUE,
  eval = (require(mice) & require(theorytools) & require(metaforest) & require(bain) & knitr::is_html_output()),
  comment = "#>"
)
```
...
```{r, echo=FALSE, fig.width=6,fig.height=4,fig.align='center', fig.cap="An illustration of  parameters of the random-effects-model", fig.alt="An illustration of  parameters of the random-effects-model"}
library(png)
library(grid)
img <- readPNG("./include/density.png")
grid.raster(img)
```
...
```{r out.width="70%", fig.cap="Illustration of an overfitted model vs. model with a good fit"}
