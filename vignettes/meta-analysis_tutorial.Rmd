...
These examples assume you already have a dataset with the **calculated effects and SE** for each study. The `curry` data set, inside the `metaforest` package, will do.
...
We could include both predictors from the previous exercises in a multiple meta-regression as follows:
