...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(99, 97, "end", "model_horseshoe_MA");
    return reader;
}
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(b, horseshoe(zb, hs_local, hs_global, (pow(hs_scale_slab, 2) * hs_slab), pstream__));
            ...
            lp_accum__.add((student_t_log(hs_local, hs_df, 0, 1) - (rows(hs_local) * stan::math::log(0.5))));
            current_statement_begin__ = 86;
            lp_accum__.add(student_t_log(Intercept, 3, 0.1, 2.5));
            current_statement_begin__ = 87;
            lp_accum__.add((student_t_log(hs_global, hs_df_global, 0, hs_scale_global) - (1 * stan::math::log(0.5))));
            current_statement_begin__ = 89;
            lp_accum__.add(inv_gamma_log(hs_slab, (0.5 * hs_df_slab), (0.5 * hs_df_slab)));
