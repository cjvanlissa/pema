...
y_i=θ+ϵ_i  						(1)
Where 𝜃 is the true effect size of each individual study i and 𝜖i follows the distribution of N(0 , vi) with vi being the sampling error or within-study variance, which is treated as a known factor.
...
y_i= θ_i+ϵ_i 						(2)
With 𝜖i ~ N(0 , vi) but, in this case 𝜃i on itself is given by:
θ_i=μ+ζ_i 						(3)
