...
One commonly used penalty is the L1-norm of the regression coefficients, or LASSO penalty ([@tibshirani1996]),
...
For the horseshoe prior, we use an extension proposed by [@PiironenVehtari2017b] called the regularized horseshoe:
