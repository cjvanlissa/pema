...
The mean sample size per study [$\bar{n}$] also had a moderate effect. For all algorithms the effect of $\bar{n}$ was positively linearly related to $R^{2}$ with the Pema and RMA algorithms performing best and Metaforest performing worse. Image 5 shows the relationship.
