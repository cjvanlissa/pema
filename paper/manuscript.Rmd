...
Thus, to equalize predictor scales, a widely used technique is standardization ([@gelman2008scaling]). Standardization sets the mean of all predictors to 0 and their standard deviation to 1. It does so by transforming all observations in the predictor space $\mathbf{X}$ to Z-scores as follows:
