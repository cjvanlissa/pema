...
In penalized regression, however, the choice of coding might affect model fit and interpretation ([@chiquet2016coding; @detmer2020note]).<!--ELI: weet je dit zeker? Ik heb nu gezegd "might" affect model fit and interpretation, omdat ik het niet zeker weet. Kan jij checken en als het inderdaad zo is, hier "does affect" van maken? -->
In `brma()`, the default is to use dummy coding for categorical predictors and standardize the dummies.
Users may specify alternative solutions, keeping in mind the aforementions considerations. 
